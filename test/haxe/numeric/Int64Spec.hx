...
class Int64Spec extends TestBase {
	...
	public function specParseBits() {
		Int64.parseBits('0000 0000 0000 0000 0000 0000 0000 0000').isTypeInt32();

		Int64.create(0) == Int64.parseBits('0000 0000 0000 0000 0000 0000 0000 0000');
		Int64.create(3) == Int64.parseBits('0000 0000 0000 0000 0000 0000 0000 0011');
		Int64.MAX == Int64.parseBits('0111 1111 1111 1111 1111 1111 1111 1111');
		Int64.MIN == Int64.parseBits('1000 0000 0000 0000 0000 0000 0000 0000');
		Int64.create(-3) == Int64.parseBits('1111 1111 1111 1111 1111 1111 1111 1101');
		Int64.create(-1) == Int64.parseBits('1111 1111 1111 1111 1111 1111 1111 1111');
		...
		Assert.raises(
			() -> Int64.parseBits('1111 1111 1111 1111 1111 1111 1111 111'),
			InvalidArgumentException
		);
	}
